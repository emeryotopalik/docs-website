...
NRQL queries made through NerdGraph are subject to [NRQL Rate Limits](/docs/query-your-data/nrql-new-relic-query-language/get-started/rate-limits-nrql-queries).
